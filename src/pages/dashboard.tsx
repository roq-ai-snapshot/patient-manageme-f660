...
import { useRoqPlatformUserProfiles, usePrescriptionCount, usePatientCount, useDoctorCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const doctorStat = useDoctorCount();
