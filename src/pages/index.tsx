  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Patient Management Application - Ensuring Comprehensive Tracking and Care for Your Patients, All in One Place"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1584515933487-779824d29309?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwYXRpZW50fGVufDB8fHx8MTY5ODI0NTI0NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Patient Management Application - Ensuring Comprehensive Tracking and Care for Your Patients, All in One Place`}
            </Text>
            <Box
